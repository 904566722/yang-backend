...
var UpdateWaterCltFailed = models.ErrorResponse{ResponseBase: models.ResponseBase{Code: "flow.0101", Message: "update water clt failed"}}
var DeleteWaterCltFailed = models.ErrorResponse{ResponseBase: models.ResponseBase{Code: "flow.0101", Message: "delete water clt failed"}}
